...
<!--				<text class="iconfont icongouwuche3" @tap="navTo('/pages/cart/cart', 'tab')"></text>-->
		...
		<view class="menu"  @tap.stop="showPhoneDialog">
			<image :src="`https://yzimg.jikebang.com/gczh/imgs/jxb/zjzc.png`" mode="widthFix" ></image>
		</view>
		<tui-modal :show="showPhoneModal" @click="dialogConfirm" :button="modalButton" title="我来帮您找设备" :content="'请拨打18054450314联系我'"></tui-modal>
	</view>
</template>
<script>
	export default {
