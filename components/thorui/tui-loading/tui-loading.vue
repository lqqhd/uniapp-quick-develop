<template>
	<view class="tui-loading tui-loading__box" :style="{ backgroundColor: backgroundColor, color: color }" v-if="type === 'column'">
		<image class="tui-loading__ani" :src="src"></image>
		<view class="tui-loading__text">{{ text }}</view>
	</view>
	<view v-else class="tui-loading tui-loading__row">
