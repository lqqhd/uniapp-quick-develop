	...
	<view class="about" v-if="!loading">
		...
		<view class="history-section icon">
			...
			<view class="qrcode-wrapper">
				...
				<text class="info">工程找活儿二维码</text>
			</view>
		</view>
		<view style="margin: 30px;text-align: center">
			<view>Copyright © 2020-2022</view>
			<view>北京极客帮科技有限公司 版权所有</view>
		</view>
	</view>
</template>
<script>
