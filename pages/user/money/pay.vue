	...
	methods: {
		...
		async confirm() {
			...
			switch (parseInt(this.payType, 10)) {
				case 1:
					console.log("页面中发起微信支付，调用$mPayment的weixinPay...")
					console.log(this.$mPayment)
					let params =  {
					...
					console.log("支付参数是:"+JSON.stringify(params))
					await this.$mPayment.weixinPay('order',params, route, this.code);
					break;
				case 2:
				...
				case 5:
					...
					await this.$mPayment.balancePay(JSON.stringify({
						orderCode: this.orderCode,
						type: 1,
