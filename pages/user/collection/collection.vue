...
<!--					></image>-->
				...
				<view class="mid">
					...
					<view class="data">
<!--						<view class="item"><text class="iconfont icontuandui"></text>评价{{ (item.sku && item.sku.commentCount) || 0 }}</view>-->
<!--						<view class="item"><text class="iconfont iconkechakan"></text>好评{{ (item.sku && item.sku.goodCommentCount) || 0 }}</view>-->
					</view>
					<view class="bottom">
<!--						<text class="price" :class="'text-' + themeColor.name">{{ moneySymbol }}{{item.sku && item.sku.price}}</text>-->
