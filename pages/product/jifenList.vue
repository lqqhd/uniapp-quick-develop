<template>
	<view class="container product-list">
		...
		<view class="product-list-wrapper">
				<rf-jifen-list :bottom="0" :list="productList" :isList="isList" :style="{paddingTop: dropScreenH+10 + 'upx' }"></rf-jifen-list>
		</view>
		<rf-load-more
			:status="loadingType"
...
<script>
	...
	import rfJifenList from '@/components/rf-jifen-list';
	import rfLoadMore from '@/components/rf-load-more/rf-load-more';
	import { querypointskulist,
            querypointtype ,
            querypointskudetail ,
            queryhotpointskulist } from '@/api/userInfo';
